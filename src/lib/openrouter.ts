...
export const OR_MODELS: ORModel[] = [
  ...
  { id: "cohere/command-a:free", label: "Cohere Command A — Kalkulator (besplatno)", free: true, specialist: "math" },
  { id: "google/gemma-3-27b-it:free", label: "Google Gemma 3 27B (besplatno)", free: true },
  { id: "google/gemma-3-12b-it:free", label: "Google Gemma 3 12B (besplatno)", free: true, specialist: "fast" },
  { id: "inclusionai/ling-1t:free", label: "Ling 1T — Brzi skener listića (besplatno)", free: true, specialist: "fast" },
  { id: "deepseek/deepseek-chat-v3.1:free", label: "DeepSeek Chat v3.1 (besplatno)", free: true, specialist: "math", ctx: "163k" },
  ...
  { id: "moonshotai/kimi-k2:free", label: "Moonshot Kimi K2 (besplatno)", free: true, specialist: "reasoning" },
  ...
  { id: "anthropic/claude-sonnet-4.5", label: "Anthropic Claude Sonnet 4.5 (plaćeno)", free: false },
  { id: "google/gemini-2.5-pro", label: "Google Gemini 2.5 Pro (plaćeno)", free: false },
];
